...
function getMainModule(spaceship: Spaceship): MainModule {
    let filtered = getModulesByType(spaceship, ModuleTypes.MainModule);
...
function getMainModuleType(spaceship: Spaceship): MainModuleType {
