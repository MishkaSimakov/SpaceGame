...
export const drawCards = async (game: Game) => {
    ...
    return await game.emitToCurrentPlayerAndWait('chooseCardType', async (cardType: string) => {
        ...
        if (cardType === 'event') {
            ...
            do {
                ...
                if (game.currentPlayer.spaceship.getMainModuleType() === MainModuleType.DrawAnotherEventCard
                    ...
                    await game.emitToCurrentPlayerAndWait('drawAnotherEventCard', (drawAnotherEventCard: boolean) => {
            ...
            do {
                ...
                if (game.currentPlayer.spaceship.getMainModuleType() === MainModuleType.DrawAdditionalModuleCard
                    ...
                    await game.emitToCurrentPlayerAndWait('drawAdditionalModuleCard', (drawAdditionalModuleCard: boolean) => {
